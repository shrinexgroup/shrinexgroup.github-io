...
Cal("init", "alliance-call", {origin:"https://app.cal.eu"});

  
  // Important: Please add the following attributes to the element that should trigger the calendar to open upon clicking.
  // `data-cal-link="shrinexgroup/alliance-call"`
  // data-cal-namespace="alliance-call"
  // `data-cal-config='{"layout":"month_view","useSlotsViewOnSmallScreen":"true"}'`

  Cal.ns["alliance-call"]("ui", {"hideEventTypeDetails":false,"layout":"month_view"});
  </script>
